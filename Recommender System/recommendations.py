...
def sim_distance(prefs, person1, person2):
    ...
    sum_of_squares = sum([pow(prefs[person1][it] - prefs[person2][it], 2) for it in si])
...
def loadMovieLens(path='C:\Users\Shubham\PycharmProjects\Recommender System\ml-100k'):
    # Get movie titles
    movies = {}
